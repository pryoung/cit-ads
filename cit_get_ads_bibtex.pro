...
;        new error.
;      Ver.10, 16-May-2022, Peter Young
;        I now do up to six calls to sock_post in case there are internet
;        problems. 
;-
...
;
; Below I (optionally) do multiple calls with sock_post in case there
; are any internet problems.
;
FOR i=0,5 DO BEGIN
